/**********************************************************************************************************************
 ...
 //      se incializan directamente las direcciones de memoria de los registros de los perifericos en cuestión
 ************************************************************************************************************************/
/************************************************************************************************
        ...
        if (Gpio_pin_in(0x10) != 1) // ENTRA AL PRESIONAR EL SWITCH DEL PUERTO P1.4 (CUANDO ESTA EN BAJO)
        {
            if (bandera == FALSE)
            {
                ...
                while (bandera == TRUE)
                {
                    ...
                    for (i = RETARDO; i > 0; i--);
                    if (Gpio_pin_in(0x10) != 1)
                        bandera = FALSE; // ENTRA CUANDO PRESIONAMOS BOTON DE P1.4
